...
int TableCapture(aSubRecord *precord) {
//    printf("Hello from TableCapture....\n");
    int *Adc = (int *)precord->a;
    int tp1Delay = *(int *)precord->b;
    int tp2Delay = *(int *)precord->c;
    int tp3Delay = *(int *)precord->d;
...
epicsRegisterFunction(TableCapture);
